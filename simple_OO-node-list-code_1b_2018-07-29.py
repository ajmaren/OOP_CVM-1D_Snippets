...
print("Select a row number between 0 and ", totalRows, "inclusive" )
...
print("Select a column number between 0 and ", totalColumns, "inclusive" )    
userCol = int(input("Please enter a column number: "))
success = True
if userCol>totalColumns:
    success = False
if userCol<0:
    success = False   
if success == True:
...
nodeNum = userRow*totalColumns + userCol
node1Activ = NodeList[nodeNum].activ
...
nodeNum2 = userRow2*totalColumns + userCol2
node2Activ = NodeList[nodeNum2].activ
